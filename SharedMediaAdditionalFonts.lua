...
-- FONT
-- -----
SharedMediaAdditionalFonts:Register("font", "GothamNarrowUltra", [[Interface\Addons\SharedMediaAdditionalFonts\fonts\GothamNarrowUltra.ttf]])
SharedMediaAdditionalFonts:Register("font", "Darian", [[Interface\Addons\SharedMediaAdditionalFonts\fonts\Darian.ttf]])
